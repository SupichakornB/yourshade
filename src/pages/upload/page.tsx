...
export default function UploadPage() {
  ...
  return (
  <div className="min-h-screen overflow-hidden p-6 md:bg-[url(@/assets/bg-upload-image.png)] bg-[length:800px] md:bg-[length:1300px] bg-no-repeat bg-fixed bg-center">      <div>
        <img
          src={backIcon}
          alt="homeImage"
