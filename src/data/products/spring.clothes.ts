...
export const SPRING_CLOTHES: Product[] = [
 ...
 { id: "8",  name: "Pattern-knit cotton top",             brand: "H&M", type: "clothes", choice: false, season: "spring", buttonlink: "", images: [{ url: "/products/spring/clothes/pattern-knit-cotton-top-1.jpg", isPrimary: true }, { url: "/products/spring/clothes/pattern-knit-cotton-top-2.jpg" }] },
